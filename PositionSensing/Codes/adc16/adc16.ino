...
void loop()
{
  ...
  readCnt = readCnt == 149 ? 0 : readCnt + 1;

  // Get the average
  unsigned long totalReadings = 0;
  for (unsigned char cnt = 0; cnt < 150; cnt++) {
    totalReadings += readings[cnt];
  }
  //Serial.print(convertedValue); Serial.print("\t"); Serial.println(totalReadings / 150);
